...
{
   public class DoctorService : Util.IUserValidation, IService<Model.User.Doctor, UserID>, IUserService<Model.User.Doctor>
   {
      ...
      public IEnumerable<Doctor> GetFilteredDoctors(Util.DoctorFilter filter)
      {
        ...
        public Repository.Abstract.User.IDoctorRepository iDoctorRepository;

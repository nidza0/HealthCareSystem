...
namespace Model.Patient
{
   public class Disease
   {
      ...
      public void AddAdministratedFor(Medicine newMedicine)
      {
         if (newMedicine == null)
            return;
         if (this.administratedFor == null)
            this.administratedFor = new System.Collections.ArrayList();
         if (!this.administratedFor.Contains(newMedicine))
         {
            this.administratedFor.Add(newMedicine);
      ...
      public void RemoveAdministratedFor(Medicine oldMedicine)
      {
         if (oldMedicine == null)
            return;
         if (this.administratedFor != null)
            if (this.administratedFor.Contains(oldMedicine))
            {
               this.administratedFor.Remove(oldMedicine);

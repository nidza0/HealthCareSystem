   ...
   public class Therapy
   {
      ...
      public void AddTherapyDose(TherapyDose newTherapyDose)
      {
         if (newTherapyDose == null)
            return;
         if (this.therapyDose == null)
            this.therapyDose = new System.Collections.Generic.List<TherapyDose>();
         if (!this.therapyDose.Contains(newTherapyDose))
            this.therapyDose.Add(newTherapyDose);
      }
      ...
      public void RemoveTherapyDose(TherapyDose oldTherapyDose)
      {
         if (oldTherapyDose == null)
            return;
         if (this.therapyDose != null)
            if (this.therapyDose.Contains(oldTherapyDose))
               this.therapyDose.Remove(oldTherapyDose);
      }
